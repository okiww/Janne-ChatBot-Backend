...
def Test():
    rv = [
        { "id": 1, "message": "Iesha the TeenBoT\n---------" }, 
        { "id": 2, "message": "Talk to the program by typing in plain English, using normal upper-" },
        { "id": 3, "message": "and lower-case letters and punctuation. Enter quit when done." },
        { "id": 5, "message": "hi!! i'm iesha! who r u??!" }
    ]

    response.content_type = 'application/json'
    Chat(pairs, reflections)

    return dumps(iesha_chatbot.converse())
